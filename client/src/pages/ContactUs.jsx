              ...
              <div className="contact-left-section pe-lg-4">
                ...
                <div className="contact-info-item">
                  ...
                  <div>
                    ...
                    <p className="contact-value">123 Innovation Drive, Tech City, TC Lucknow</p>
                  </div>
                </div>
                ...
                <div className="contact-info-item">
                  ...
                  <div>
                    ...
                    <p className="contact-value">+91 8081715595</p>
                  </div>
                </div>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            placeholder="Vikash Vishwakarma"
                            required
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={handleChange}
                            placeholder="vikash99mgs@example.com"
                            required
                            className="contact-form-control"
                          />
                        </Form.Group>
