...
import { SocketProvider } from "./context/SocketContext"; // ✅ Voice call context
import IncomingCallModal from "./components/IncomingCallModal"; // ✅ Global incoming call popup
      ...
      <ThemeProvider>
        <SocketProvider>
          <Router>
            ...
            <Chatbot />
            {/* ✅ Global incoming call popup — visible from any page */}
            <IncomingCallModal />
          </Router>
        </SocketProvider>
      </ThemeProvider>
